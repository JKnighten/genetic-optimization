...
public class NQueensProblem implements IGenOptimizeProblem<NQueensIndividual> {
     ...
     * the number of conflicts that are on the board contained in the NQueensIndividuals. Queens are in conflict if they
     * may take one another (ie. they are in the same row or diagonal). This uses NQueensHelper to calculate the amount
     * of conflict.
     *
    ...
    public void calculateFitness(List<NQueensIndividual> population) {
        for(Individual individual: population)
            individual.setFitness(NQueensHelper.conflictScore((Integer[]) individual.getValue()));
